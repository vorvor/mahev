$(document).ready(function() {
	...
	function loadImages(i, dir) {
		if (i < 406 && i > -1) { 
			...
			picstring = path + '/' + project +'/' + project + '_' + picnumstring + '.jpg';
			$('#configurator .inset-0').append('<img class="hidden sequence-image ' + project + '-' + picnumstring + '" src="' + picstring + '">');
			if (dir == 'right') {
	...
	function loadZoominImages(i) {
		if (i < 77) {
			...
			$('#configurator .inset-0').append('<img class="hidden sequence-image ' + innerProject + '-' + picnumstring + '" src="' + picstring + '">');
